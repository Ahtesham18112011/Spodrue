...
set_clock_transition -rise -min 156 [get_clocks dco_clk]
set_clock_transition -fall -min 157 [get_clocks dco_clk]
...
set_clock_transition -rise -min 157 [get_clocks lfxt_clk]
set_clock_transition -fall -min 158 [get_clocks lfxt_clk]
